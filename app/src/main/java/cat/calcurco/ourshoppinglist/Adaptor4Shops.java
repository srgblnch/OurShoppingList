...
public class Adaptor4Shops extends
        RecyclerView.Adapter<Adaptor4Shops.ViewHolder> {
    final static String TAG = "Adaptor4Shops";
    ...
    public Adaptor4Shops(Context context, Shops shops) {
    ...
    @Override
    public Adaptor4Shops.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // Inflamos la vista desde el xml
        View v = inflater.inflate(R.layout.shop_view, parent, false);
        v.setOnClickListener(onClickListener);
        v.setOnLongClickListener(onLongClickListener);
        return new Adaptor4Shops.ViewHolder(v);
    }

    // Using the ViewHolder as basement, populate it
    @Override
    public void onBindViewHolder(Adaptor4Shops.ViewHolder holder, int position) {
    ...
    public void populateView(Adaptor4Shops.ViewHolder holder, Shop shop) {
